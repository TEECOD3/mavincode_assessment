...
class DashboardApi {
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Failed to retrieve dashboard item",
        success: false,
        timestamp: new Date().toISOString(),
      };
    }
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Failed to create dashboard item",
        success: false,
        timestamp: new Date().toISOString(),
      };
    }
  ...
  async getDashboardItemsByCategory(
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Failed to retrieve dashboard items by category",
        success: false,
        timestamp: new Date().toISOString(),
      };
    }
    ...
    try {
      ...
      return {
        ...
        message:
          error instanceof Error
            ? error.message
            : "Failed to retrieve dashboard items by status",
        success: false,
        timestamp: new Date().toISOString(),
      };
    }
